          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className={`absolute -bottom-10 -left-10 p-8 rounded-3xl border max-w-xs hidden md:block transition-all ${isDarkMode ? 'glass-morphism border-white/10' : 'bg-white/90 backdrop-blur-xl border-black/10 shadow-xl'}`}>
                ...
                <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Fale com o nosso Especialista em OOH e DOOH, o NEO. Clique no ícone do Agente à sua direita e descubra o poder da Mídia Inteligente.</p>
              </div>
            </motion.div>
          </div>
        </div>
